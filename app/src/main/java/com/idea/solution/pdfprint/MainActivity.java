package com.idea.solution.pdfprint;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void createPDFFile(String path) {
        ...
        try {
            ...
            document.addAuthor("Idea Solutions");
            document.addCreator("Mofizur");
            ...
            addNewItem(document, "#313131", Element.ALIGN_CENTER, orderNumberValueFont);

            addLineSeparator(document);

            addNewItem(document, "Order Date", Element.ALIGN_LEFT, orderNumberFont);
            addNewItem(document, "12/10/2020", Element.ALIGN_LEFT, orderNumberValueFont);

            addLineSeparator(document);

            addNewItem(document, "Account Name: ", Element.ALIGN_LEFT, orderNumberFont);
            addNewItem(document, "CName", Element.ALIGN_LEFT, orderNumberValueFont);
            ...
            //Item 1
            addNewItemWithLeftAndRight(document, "Pizza 42", "(0.0%)", titleFont, orderNumberValueFont);
            addNewItemWithLeftAndRight(document, "12.0*1000", "12000.0", titleFont, orderNumberValueFont);

            addLineSeparator(document);

            //Item 2
            addNewItemWithLeftAndRight(document, "Pizza 43", "(0.0%)", titleFont, orderNumberValueFont);
            addNewItemWithLeftAndRight(document, "12.0*1000", "12000.0", titleFont, orderNumberValueFont);
